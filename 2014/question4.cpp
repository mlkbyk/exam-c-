...
public:
	...
	Base1(double a) {
		x = a;
		cout << "Consturcting Base1 " << x << endl;

	}
	~Base1() {
		cout << "Destructing Base1 " << x << endl;
...
public:
	Derived1(double a, double b):Base1(a) {
		y = b;
		cout << "Consturcting Derived1 " << y << endl;

	}
	~Derived1() {
		cout << "Destructing Derived1 " << y << endl;
	}
};
...
public:double z;
	  ...
	  ~Derived2() {
		  cout << "Destructing Derived2 " << z << endl;
